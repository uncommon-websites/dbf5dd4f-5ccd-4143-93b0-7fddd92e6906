<section class="px-6 md:px-12 pb-24 bg-white">
  <div class="rounded-2xl overflow-hidden relative bg-gradient-to-br from-[#0a0a0a] to-[#1a1a1a] text-white p-8 md:p-16 min-h-[500px] flex flex-col justify-between">
    <!-- Background overlay/image could go here -->
    
    <div>
      <h2 class="text-2xl md:text-3xl font-bold mb-2">Ready to give your marketing team</h2>
      <h2 class="text-2xl md:text-3xl font-bold">the autonomy they deserve?</h2>
    </div>

    <div class="bg-white text-black rounded-xl p-6 md:p-8 max-w-md self-end w-full flex items-center gap-6">
      <div class="flex-1">
        <h3 class="font-bold text-lg">Let's Talk</h3>
        <p class="text-xs text-gray-500 mb-6">Start your Growth Engine Sprint</p>
      ...
      <div class="w-24 h-24 rounded-lg overflow-hidden bg-gray-200 shrink-0 flex items-center justify-center">
